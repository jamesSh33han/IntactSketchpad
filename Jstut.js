...
// Method that accepts as parameters the string we want to add, setting other recognition properties
...
function SaveImage(){
    ...
    imageFile.setAttribute('download', 'image.svg');
